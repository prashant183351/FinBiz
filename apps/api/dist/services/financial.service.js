...
class FinancialService {
     ...
     */
    static async createTransactionWithLedger(data) {
     ...
     */
    static async createLedgerEntriesForTransaction(transaction) {
        const entries = [];
     ...
     */
    static async getProfitLoss(companyId, startDate, endDate) {
